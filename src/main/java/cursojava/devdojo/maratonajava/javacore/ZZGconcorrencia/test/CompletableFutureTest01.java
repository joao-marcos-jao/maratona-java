...
public class CompletableFutureTest01 {
    public static void main(String[] args) {
       ...
       // searchPriceSyc(storeService);
       // searchPriceAsycFuture(storeService);
        searchPriceAsyncCompletableFuture(storeService);

    }
    private static void searchPriceSyc(StoreService storeService){
        ...
        System.out.printf(" Time passed to serachPriceSync %dms%n",(end-start));

    }
    private static void searchPriceAsycFuture(StoreService storeService){
        long start = System.currentTimeMillis();
