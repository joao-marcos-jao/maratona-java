package cursojava.devdojo.maratonajava.javacore.ZZFthreads.dominio;
...
public class Members {
    ...
    public String retrieveEmail() throws InterruptedException {
        ...
        synchronized (this.emails){
            while (emails.size() == 0){
                if (!open) return null;
                System.out.println(Thread.currentThread().getName() + "Não tem email na lista, entrando em modo de espera");
                this.emails.wait();
            }
